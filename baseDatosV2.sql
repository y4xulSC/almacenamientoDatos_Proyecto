...
CREATE TABLE usuario (
    ...
    idRol INT NOT NULL, -- OPCIONAL hasta NO tener claro su función
...
ALTER TABLE metodoTransporte ADD FOREIGN KEY (idDomiciliario) REFERENCES domiciliario(idDomiciliario);

CREATE TABLE envio (
    idEnvio INT AUTO_INCREMENT NOT NULL,
    -- idCliente VARCHAR(255) NOT NULL, -- NO ES NECESARIO
    idDireccion INT NOT NULL,
    idCompra INT NOT NULL,
    ...
    PRIMARY KEY (idEnvio),
    -- FOREIGN KEY (idCliente) REFERENCES cliente(idCliente), -- NO ES NECESARIO
